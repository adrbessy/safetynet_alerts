...
class PersonServiceTest {
  ...
  public void testGetPersonNumberInfoListFromStationNumber() {
     ...
     * fireStationList.add(fireStation1); fireStationList.add(fireStation2);
     * 
     * when(firestationRepository.findDistinctByStation(Mockito.anyInt())).
     * thenReturn(fireStationList);
     * 
     * List<PersonNumberInfo> personNumberInfoList =
     * personService.getPersonNumberInfoListFromStationNumber(1);
