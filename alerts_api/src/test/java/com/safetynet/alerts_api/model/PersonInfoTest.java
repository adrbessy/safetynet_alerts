...
class PersonInfoTest {
  ...
  List<Integer> firestationNumber;
  ...
  private void setUp() {
    ...
    firestationNumber = new ArrayList<Integer>();
    firestationNumber.add(4);
    firestationNumber.add(5);
    ...
    personInfo = new PersonInfo(personList, firestationNumber);
  }
  ...
  public void testGetFirestationNumber() throws Exception {
    assertThat(personInfo.getFirestationNumber()).isEqualTo(firestationNumber);
  }
